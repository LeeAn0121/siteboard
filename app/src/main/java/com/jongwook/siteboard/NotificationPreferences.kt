...
object NotificationPreferences {
    ...
    private const val KEY_INSPECTION_REMINDER = "notify_inspection_reminder"
    ...
    fun isInspectionReminderEnabled(context: Context): Boolean = read(context, KEY_INSPECTION_REMINDER, true)
    ...
    fun setInspectionReminderEnabled(context: Context, enabled: Boolean) = write(context, KEY_INSPECTION_REMINDER, enabled)
